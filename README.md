# Starfox 64: Recompiled Mod Template

This is an example mod for Starfox 64: Recompiled that can be used as a template for creating mods. It has a basic build system, headers, sample code, and a mod config toml.
...
### Updating the Starfox 64 Decompilation Submodule
Mods can also be made with newer versions of the Starfox 64 decompilation instead of the commit targeted by this repo's submodule.
...
* Try building.
  ...
  * If RecompModTool fails due to a function "being marked as a patch but not existing in the original ROM", it's likely that function you're patching was renamed in the Starfox 64 decompilation.
